...
import { StudentsContext } from "../context/StudentsProvider"; // Import StudentsContext
...
const ImportCSV = ({ onImportComplete }) => {
  ...
  const { addStudents } = useContext(StudentsContext); // Use StudentsContext
  ...
  const handleImport = () => {
    ...
    const students = parsedData.map((row, index) => {
      ...
      if (!student.id && student.studentId) {
        ...
        student.id = `student-${Date.now()}-${index}`;
      }
    ...
    if (typeof onImportComplete === "function") {
      ...
      console.error("onImportComplete is not a function");
    }
        ...
        {!previewing ? (
          <div className="space-y-4">
            <div className="border-2 border-dashed rounded-md p-6 text-center">
              ...
              <h3 className="font-medium mb-1">Upload your CSV file</h3>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <h3 className="font-medium">Map CSV Columns to Student Fields</h3>
...
// Define prop types for ImportCSV
ImportCSV.propTypes = {
  onImportComplete: PropTypes.func.isRequired, // Ensure onImportComplete is a function
};
